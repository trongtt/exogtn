...
public class OAuthConsumerService
{
   ...
   public void addConsumerInfo(String consumerKey, String consumerSecret, String keyTypeStr, String callbackURL, String gadgetURIStr, String serviceName) throws URISyntaxException
   {
