 ...
 */
public class Twitter2LeggedConsumer extends HttpServlet
{
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
   {
      ...
      try
      {
         ...
         {
            request.getRequestDispatcher("twittertoken.jsp").forward(request, response);
            return;
         }
         ...
         OAuthResponseMessage result =
            CookieConsumer.CLIENT.access(accessor.newRequestMessage(OAuthMessage.GET,
               "https://api.twitter.com/1/statuses/home_timeline.xml", null), ParameterStyle.AUTHORIZATION_HEADER);
